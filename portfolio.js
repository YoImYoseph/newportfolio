...
document.getElementById('HTML5/CSS3').addEventListener('click', filterSelection.bind(null, 'HTML5/CSS3'));
...
document.getElementById('navbarSkill').addEventListener('click', moveTo.bind(null,'skills'));
